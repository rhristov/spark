...
import parquet.schema.{Type => ParquetType, PrimitiveType => ParquetPrimitiveType,
  GroupType => ParquetGroupType, OriginalType => ParquetOriginalType, Types => ParquetTypes,
  DecimalMetadata, MessageType, ConversionPatterns}
